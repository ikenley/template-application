...
select efcstate
	...
	, region_id 
	, SUM(efres02)
from base.ef2018c_rv en
join base.state_region sr
	on en.efcstate = sr.fips
group by efcstate
	, abbreviation
	, name
	, region_id 
...
--
--drop table if exists base.predicted_enrollment;
--
--CREATE TABLE base.predicted_enrollment (
--	index int,
--	row int,
--	col int, 
--	region int,	
...
--
--SELECT aws_s3.table_import_from_s3(
--   'base.predicted_enrollment',
--   '',
--   'CSV HEADER ENCODING ''WIN1252''',
--   aws_commons.create_s3_uri('924586450630-data-lake', 'template-app/base/lookups/predicted_enrollment.csv', 'us-east-1')
--);
--
--select *
--from base.predicted_enrollment
--limit 100
--;
